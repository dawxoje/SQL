--DROP TABLE ANALISIS;DROP TABLE FEDERATIVO;DROP TABLE LABORATORIO;DROP TABLE ARBITRAR;DROP TABLE GOL;DROP TABLE JUGAR;DROP TABLE ARBITRO;DROP TABLE PARTIDO;DROP TABLE JUGADOR;DROP TABLE EQUIPOS;
